...
export class DashboardComponent implements OnInit, OnDestroy {
    ...
    fileUrl = env.FILE_PUBLIC_BASE_URL;
    ...
    selectDateType(type: { id: string; name: string }, typeNumber: number): void {
        ...
        if(type.id === 'threeMonthAgo') params.threeMonthAgo = this.threeMonthAgo;
        if(type.id === 'sixMonthAgo') params.sixMonthAgo = this.sixMonthAgo;
